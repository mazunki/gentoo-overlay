...
EGIT_REPO_URI="https://github.com/kcat/openal-soft.git"
...
IUSE="
	alsa coreaudio debug jack oss portaudio pulseaudio sdl sndio qt5 pipewire
...
RDEPEND="
	...
	pipewire? ( >=media-video/pipewire-0.3.43-r3[${MULTILIB_USEDEP}] )
	qt5? (
		dev-qt/qtcore:5
		dev-qt/qtgui:5
		dev-qt/qtwidgets:5
